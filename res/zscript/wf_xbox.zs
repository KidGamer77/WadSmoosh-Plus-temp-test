//-----------------------------------------------------------------------------
// Xbox secret-exit + MAP33 compatibility.
// Apply is NOT virtual on UZDoom 5 — do not use override.
//-----------------------------------------------------------------------------

class XboxSecretExits : LevelPostProcessor
{
    private bool XboxExitsOn()
    {
        let cv = CVar.FindCVar("wf_xbox_secret_exits");
    ...
    protected void Apply(Name checksum, String mapname)
    {
        ...
        switch (checksum)
        {
            case '915409A89746D6BFD92C7956BE6A0A2D': // BFG MAP33
            case '9F0954A61E12088BB843AC9400445517': // Xbox MAP33

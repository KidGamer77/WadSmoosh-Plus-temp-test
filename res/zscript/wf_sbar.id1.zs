//-----------------------------------------------------------------------------
// LoR / ID24 status bar.
// Packer copies this file to zscript/wf_sbar.zs.
// Do NOT #include this file from zscript.txt.
// zscript.txt must include ONLY zscript/wf_sbar.zs.
//-----------------------------------------------------------------------------
...
class WadFusionStatusBarId24 : BaseStatusBar
{
    ...
    protected virtual void DrawBarAmmo()
    {
        ...
        int mode = WeapSwapMode();
        bool swapLoR = (mode == 1);
        bool swapAlways = (mode >= 2);

        bool showId24 =
            CVBool("wf_hud_id24", false) ||
            (lor && swapLoR && cell != null && (hasPlasmaRifle != null || hasBfg9000 != null)) ||
            (lor && !swapLoR && fuel != null && (hasIncinerator != null || hasHeatwave != null)) ||
            (!lor && swapAlways && cell != null && (hasPlasmaRifle != null || hasBfg9000 != null)) ||
            (!lor && !swapAlways && fuel != null && (hasIncinerator != null || hasHeatwave != null));

        int amt1, maxamt;

        if (showId24 && HasGfx("STAMMO24"))
        {
    ...
    protected void DrawFullScreenStuff()
    {
        ...
        int hudArmorOffset = swapHA ? 20 : 0;
        DrawImage((berserk != null) ? "PSTRA0" : "MEDIA0", (20 + ultraWide, -2 - hudArmorOffset));
        DrawString(mHUDFont, FormatNumber(CPlayer.health, 3), (44 + ultraWide, -20 - hudArmorOffset));

        let armor = CPlayer.mo.FindInventory("BasicArmor");
        int hudHealthOffset = swapHA ? 20 : 0;
...
class WadFusionStatusBar : WadFusionStatusBarId24
{
}